...
<script src="<%= ctxPath%>/Highcharts-10.3.3/code/highcharts.js"></script>
<script src="<%= ctxPath%>/Highcharts-10.3.3/code/modules/exporting.js"></script>
<script src="<%= ctxPath%>/Highcharts-10.3.3/code/modules/export-data.js"></script>
<script src="<%= ctxPath%>/Highcharts-10.3.3/code/modules/accessibility.js"></script>
