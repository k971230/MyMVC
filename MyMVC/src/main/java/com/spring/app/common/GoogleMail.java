...
//==== #187. Spring Scheduler(스프링스케줄러05)
...
public class GoogleMail {
	...
	public void sendmail_Reservation(String recipient, String emailContents) throws Exception { 
        ...
        prop.put("mail.smtp.user", "qkrdbstn777@gmail.com");
        ...
        // 보내는 사람의 메일주소
        String sender = "qkrdbstn777@gmail.com";
		...
		}// end of public void sendmail_withFile(Map<String, Object> paraMap)
		...
		public void sendmail_OrderFinish(String recipient, String name, String emailContents) throws Exception{
	        ...
	        // 2. SMTP 서버의 계정 설정
	           //    Google Gmail 과 연결할 경우 Gmail 의 email 주소를 지정 
	        prop.put("mail.smtp.user", "swfkdlvm0@gmail.com");
	        ...
	        // 보내는 사람의 메일주소
	        String sender = "swfkdlvm0@gmail.com";
	        Address fromAddr = new InternetAddress(sender);
	        msg.setFrom(fromAddr);
